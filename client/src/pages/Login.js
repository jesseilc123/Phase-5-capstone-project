    ...
    return (
        ...
        <div className="bg-beige h-screen">
            <nav className="flex flex-row flex-wrap items-center justify-center lg:pt-12">
                {view === "login" ? (
                    <div className="flex flex-col bg-white xl:rounded-2xl lg:w-[1000px] lg:h-[750px] h-screen w-full">
                    ...
                    <div className="flex flex-col bg-white xl:rounded-2xl lg:w-[1000px] lg:h-[750px] h-screen w-full">
                        <div className="flex flex-wrap flex-row justify-center bg-n-green w-full xl:rounded-t-2xl lg:h-[188px]">
                            ...
                            <div className="flex flex-col items-center">
                                <h3 className="text-4xl font-bold">Join Pikmin Wiki Today!</h3>
                                <p className="text-lg mt-2 font-semibold">Already have an account?&nbsp;
