...
beckoning_mannequin = Treasure(name="Beckoning Mannequin", location=5, series="Ancient Secrets", sparklium=250, description="While looking at this statue, I found myself smiling and petting its head for no discernible reason. It must possess a magical ability to captivate people and convince them to do its bidding. How can something so devious and manipulative be so cute?")

buddy_display = Treasure(name="Buddy Display", location=3, series="Ancient Secrets", sparklium=200, description="What mysterious and fluffy creatures. I can't find evidence of them in any of the existing creature databases, but there's something familiar about them. It's almost as if I've met them before... I guess I'll chalk it up to an ancient memory that's been imprinted on my genome.")

giants_fossil = Treasure(name="Giant's Fossil", location=1, series="Ancient Secrets", sparklium=450, description="Looking upon this warrior's calming visage is a peaceful way to spend an hour. The eyes seem to see through everything, as if their gaze is freeing you from the darkness of your mind. Perhaps I've stumbled upon the sacred key to life's greatest questions.")

lamp_of_inspiration = Treasure(name="Lamp of Inspiration", location=1, series="Ancient Secrets", sparklium=300, description="This lamp is the very definition of inspiring. With the figure of a proud woman holding a torch on high, it not only lights up a room with its glow but lights up the spirits of those who gaze upon it.")

persistence_machine = Treasure(name="Persistence Machine", location=4, series="Ancient Secrets", sparklium=300, description="I've never been the type to give up. No matter how many times I fall, I'll always get back up again. At first I thought I could practice alongside this machine, but its stubby body reminds me too much of the president. One glance at it, and I lose all motivation to continue.")

crunchy_deluge = Treasure(name="Crunchy Deluge", location=5, series="Autumn Harvest", sparklium=90, description="Lots of juice in here, like having your mouth flooded in sweetness. Not much Piktamin U, but nutrition isn't everything. Sometimes you just want a natural disaster of flavor, you know?")

delectable_bouquet = Treasure(name="Delectable Bouquet", location=5, series="Autumn Harvest", sparklium=70, description="Crazy! We cut this open, and it's filled with tiny, white flowers, meaning it's not technically a fruit at all. Analysis also indicates that it won't be ripe very long before it starts to rot... I think I'll save this one for the captain.")

portable_sunset = Treasure(name="Portable Sunset", location=5, series="Autumn Harvest", sparklium=70, description="Look at the colors! It reminds me of the time I melted all my crayons and tried to combine them together into a supercrayon. I really thought that would work... Anyway, Alph doesn't like the smell of this fruit, but he doesn't have a sophisticated nose palate like I do.")
