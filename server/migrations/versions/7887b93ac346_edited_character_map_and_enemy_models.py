"""Edited Character, Map, and Enemy models

Revision ID: 7887b93ac346
Revises: 
Create Date: 2023-09-17 23:33:59.892419
...
def upgrade():
    ...
    sa.Column('sparklium', sa.Integer(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
